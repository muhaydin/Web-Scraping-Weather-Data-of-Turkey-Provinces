...
def il(x):
    driver.get(url[x])
    time.sleep(0.35)
    tah_nem_max1=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(1) > td.ng-binding:nth-child(6)").text
    time.sleep(0.35)
    tah_nem_max2=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(2) > td.ng-binding:nth-child(6)").text
    time.sleep(0.35)
    tah_nem_max3=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(3) > td.ng-binding:nth-child(6)").text
    time.sleep(0.35)
    tah_nem_max4=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(4) > td.ng-binding:nth-child(6)").text
    time.sleep(0.35)
    tah_nem_max5=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(5) > td.ng-binding:nth-child(6)").text
    time.sleep(0.35)
    tah_nem_max= [tah_nem_max1,tah_nem_max2,tah_nem_max3,tah_nem_max4, tah_nem_max5]
    time.sleep(0.35)

    tah_nem_min1=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(1) > td.ng-binding:nth-child(5)").text
    time.sleep(0.35)
    tah_nem_min2=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(2) > td.ng-binding:nth-child(5)").text
    time.sleep(0.35)
    tah_nem_min3=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(3) > td.ng-binding:nth-child(5)").text
    time.sleep(0.35)
    tah_nem_min4=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(4) > td.ng-binding:nth-child(5)").text
    time.sleep(0.35)
    tah_nem_min5=driver.find_element_by_css_selector("#_4_5gunluk > table > tbody > tr:nth-child(5) > td.ng-binding:nth-child(5)").text
    time.sleep(0.35)
    tah_nem_min=[tah_nem_min1,tah_nem_min2,tah_nem_min3,tah_nem_min4, tah_nem_min5]
    
    data = {'Nem_max':tah_nem_max, 'Nem_min':tah_nem_min}
...
df_list3.to_csv('Nem_mgm.csv', encoding='utf-8-sig')  
